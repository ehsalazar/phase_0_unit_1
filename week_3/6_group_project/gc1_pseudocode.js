...
/*
1. 	variable sum is a function (with a parameter of an array){
...
2. 	variable mean is a function (with a parameter of an array){
    	variable total is set to zero;
		for (index starts at 0, until you reach the length of an array, increment index by one) {
		total is equal to total plus the array[index];
		};
...
3. 	variable median is a function (with a parameter of an array){
